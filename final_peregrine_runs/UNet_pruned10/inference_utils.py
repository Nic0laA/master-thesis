...
class InferenceNetwork(sl.SwyftModule):
    def __init__(self, conf):
        ...
        # )
        self.unet_t = torch.load(f'/home/scur2012/Thesis/master-thesis/experiments/pruning/unet_t_pruned_0.1.pth')
        self.unet_f = torch.load(f'/home/scur2012/Thesis/master-thesis/experiments/pruning/unet_f_pruned_0.1.pth')
