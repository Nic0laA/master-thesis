...
from model import InferenceNetwork
...
training_store_path = '/scratch-shared/scur2012/trained_models/unet_attention_2'
...
network = InferenceNetwork(batch_size=256, learning_rate=5e-4)

# Fit data to model

train_data, val_data = load_data(data_dir, batch_size=256, train_test_split=0.95)
