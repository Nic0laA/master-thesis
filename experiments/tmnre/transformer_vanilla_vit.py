...
class ViTInferenceNetwork(sl.SwyftModule):
    ...
    def __init__(self, **config):
        ...
        self.noise_shuffling = config["shuffling"]
        self.num_params = 15
        self.marginals = config["marginals"]
        self.include_noise = config["include_noise"]
        ...
        self.optimizer_init = sl.AdamOptimizerInit(lr=self.learning_rate)
